# Extract wte weights from GPT-2 h5 transformer model to ggml format
#
...
if len(sys.argv) < 2:
    print("Usage: wte-h5-to-ggml.py dir-model [use-f32]\n")
    sys.exit(1)
...
if len(sys.argv) > 2:
    use_f16 = False
    fname_out = sys.argv[1] + "/ggml-gpt-wte.bin"
